...
exec mkdir -p axi_lite_ip
exec cp axi_lite.vhd axi_lite_ip 
ipx::infer_core -vendor user.org -library user -taxonomy /UserIP axi_lite_ip
set_property ip_repo_paths axi_lite_ip [current_project]
update_ip_catalog
...
exec xvlog -L axi_vip_v1_1_8 -L xilinx_vip -sv testbench.sv
